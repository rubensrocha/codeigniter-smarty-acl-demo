                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-center">
                            Don't have an account?&nbsp;<a href="<?php echo base_url('admin/register');?>"> Sign Up</a>
                        </div>
                        <div class="d-flex justify-content-center">
                            <a href="<?php echo base_url('admin/forgot_password');?>">Forgot your password?</a>
                        </div>
                        <div class="d-flex justify-content-center">
                            <a href="<?php echo base_url('admin/resend_activation');?>">Didn't receive the activation email?</a>
                        </div>
                    </div>
                </div>
            </div>
